...
#define HIMAX_DRIVER_VER "2.0.0.68_ABCD1234_01"
...
#define ACTIVE_PEN_NAME "Lenovo_Precision_Pen_2"
...
/******* SPI-end *******/
	...
	struct workqueue_struct *himax_drm_notify_wq;
	struct work_struct himax_drm_notify;
	bool ts_suspend;
	...
	uint32_t charger_detection_enable;    /*charger_detect_function*/
