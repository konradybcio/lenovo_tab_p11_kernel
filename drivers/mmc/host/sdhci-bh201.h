...
#else
#define GPIO_SD_CARD_PWR	(45)
#define GPIO_SD_CARD_PRESENT (88)
#endif
...
#if IFLYTEK
extern int sprd_sdhc_runtime_pm_get(struct sprd_sdhc_host *host);
extern int sprd_sdhc_runtime_pm_put(struct sprd_sdhc_host *host);
